            ...
            <div className="w-full max-w-md space-y-4">
                <SlideIn delay={0.1} direction="up">
                    <Link
                        ...
                        className="block group relative overflow-hidden rounded-2xl bg-primary p-8 text-primary-foreground shadow-xl transition-all hover:shadow-2xl hover:scale-105"
                    >
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold mb-1">Créer ma famille</h2>
                ...
                <SlideIn delay={0.2} direction="up">
                    <Link
                        ...
                        className="block group relative overflow-hidden rounded-2xl bg-card p-8 shadow-lg border-2 border-border transition-all hover:shadow-xl hover:scale-105 hover:border-primary"
                    >
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div className="flex-1">
                                <h2 className="text-2xl font-bold text-foreground mb-1">Rejoindre une famille</h2>
